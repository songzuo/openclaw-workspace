 ...
 *
 * This file configures Sentry for the Next.js server-side (API routes, Server Components, etc.)
...
Sentry.init({
  ...
  // Set sampling rate for transactions - this is relative to tracesSampleRate
